...
[![deploy docker image](https://img.shields.io/github/actions/workflow/status/takelwerk/takelage-pad/build_test_deploy_project_on_push.yml?label=deploy%20docker%20image)](https://github.com/takelwerk/takelage-pad/actions/workflows/build_test_deploy_project_on_push.yml)
[![deploy vagrant vbox](https://img.shields.io/github/actions/workflow/status/takelwerk/takelage-pad/build_deploy_project_vbox_on_push.yml?label=deploy%20vagrant%20vbox)](https://github.com/takelwerk/takelage-pad/actions/workflows/build_deploy_project_vbox_on_push.yml)
[![test project](https://img.shields.io/github/actions/workflow/status/takelwerk/takelage-pad/build_test_project_nightly.yml?label=test%20project)](https://github.com/takelwerk/takelage-pad/actions/workflows/build_test_project_nightly.yml)
[![test roles](https://img.shields.io/github/actions/workflow/status/takelwerk/takelage-pad/build_test_roles_nightly.yml?label=test%20roles)](https://github.com/takelwerk/takelage-pad/actions/workflows/build_test_roles_nightly.yml)
